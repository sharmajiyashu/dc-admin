<ul class="pagination pagination-primary justify-content-end mt-2">
    ...
    @else
        <li class="page-item prev">
            <a class="page-link" href="{{ $data->appends(['keyword' => $keyword])->url(1) }}" aria-label="First Page">&laquo;&laquo;</a>
        </li>
    @endif
    ...
    @else
        <li class="page-item prev">
            <a class="page-link" href="{{ $data->appends(['keyword' => $keyword])->previousPageUrl() }}" aria-label="Previous Page">&lsaquo;</a>
        </li>
    @endif
    ...
    @if ($data->hasMorePages())
        <li class="page-item next">
            <a class="page-link" href="{{ $data->appends(['keyword' => $keyword])->nextPageUrl() }}" aria-label="Next Page">&rsaquo;</a>
        </li>
    @else
    ...
    @if ($data->hasMorePages())
        <li class="page-item next">
            <a class="page-link" href="{{ $data->appends(['keyword' => $keyword])->url($data->lastPage()) }}" aria-label="Last Page">&raquo;</a>
        </li>
    @else
