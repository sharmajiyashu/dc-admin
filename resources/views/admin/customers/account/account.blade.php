                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body py-2 my-25">
                            ...
                            <div class="d-flex">
                                <a href="#" class="me-25">
                                    <img src="{{ asset('public/images/users/'.$customer->image) }}" id="account-upload-img" class="uploadedAvatar rounded me-50" alt="profile image" height="100" width="100" />
                                </a>
                            ...
                            <!-- form -->
                            <form class="validate-form mt-2 pt-50" action="{{ route('customers.update',$customer->id) }}" method="POST"  enctype="multipart/form-data">
                                {{ csrf_field() }}
                                @method('PATCH')
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6 mb-1">
                                        ...
                                        <select id="currency" name="gender" class="select2 form-select">
                                            ...
                                            <option value="Other" {{ (isset($customer) && $customer->gender == 'Other') ? 'selected' : '' }} >Other</option>
                                        </select>
                                    </div>

                                    <div class="col-12 col-sm-6 mb-1">
                                        <label class="form-label" for="accountOrganization">DOB</label>
                                        <input type="date" class="form-control" id="accountOrganization" name="dob" placeholder="dob" value="{{ $customer->dob }}" />
                                    </div>
                                    <div class="col-12 col-sm-6 mb-1">
                                        <label class="form-label" for="accountPhoneNumber">Mobile</label>
                                        <input type="number" readonly class="form-control account-number-mask" id="accountPhoneNumber" name="mobile" placeholder="Mobile" value="{{ $customer->mobile }}" />
                                    </div>
                                    <div class="col-12 col-sm-6 mb-1">
                                        <label class="form-label" for="accountAddress">State</label>
                                        <input type="text" class="form-control" id="accountAddress" name="state" placeholder="State" value="{{ $customer->state }}" />
                                    </div>
                                    <div class="col-12 col-sm-6 mb-1">
                                        <label class="form-label" for="accountState">City</label>
                                        <input type="text" class="form-control" id="accountState" name="city" placeholder="City" value="{{ $customer->city }}" />
                                    </div>
                                    <div class="col-12 col-sm-6 mb-1">
                                        <label class="form-label" for="accountState">Pin</label>
                                        <input type="text" class="form-control" id="accountState" name="pin" placeholder="Pin" value="{{ $customer->pin }}" />
                                    </div>
                                    <div class="col-12 col-sm-12 mb-1">
                                        <label class="form-label" for="accountZipCode">Address</label>
                                        <textarea name="address" class="form-control" id="" cols="30" rows="3">{{ $customer->address }}</textarea>
                                    </div>
