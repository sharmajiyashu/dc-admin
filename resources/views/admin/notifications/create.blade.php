                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <textarea class="form-control" name="body" id="exampleFormControlTextarea1" rows="3" placeholder="Body">{{ old('body') }}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-2">
                                                                <input type="checkbox" id="" name="to_vendors" value="vendor" {{ (old("to_vendors") == 'vendor' ? "checked":"") }}> <span>Vendors</span>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <input type="checkbox" id="" name="to_customers" value="customer"{{ (old("to_customers") == 'customer' ? "checked":"") }} > <span>Customers</span> 
                                                            </div>
                                                        </div> 
                                                    </div> 
                                                </div>
