                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form" action="{{ route('products.update_2') }}" method="POST" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        {{-- @method('PATCH') --}}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label"  for="last-name-column">MRP</label>
                                                    <input type="text" id="first-name-column" name="mrp" class="form-control" placeholder="MRP" value="{{ $product->mrp }}" />
                                                </div>
                                            </div>

                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label"  for="last-name-column">sp</label>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label"  for="last-name-column">Stock</label>
                                                    <input type="text" id="first-name-column" name="stock" class="form-control" placeholder="Stock" value="{{ $product->stock }}" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label"  for="last-name-column">Order Limit</label>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label"  for="last-name-column">Packing Quantity</label>
                                                        ...
                                                        @if (!empty($product->images))
                                                            @foreach ($product->images as $item)
                                                                <div class="col-md-2">
                                                                    ...
                                                                    <div><img src="{{ asset('public/images/products/'.$item) }}" alt="" width="100" class="product_image"></div>
                                                                </div>
                                                            @endforeach
                                                        @endif
                                                    </div>
