...
<div class="app-content content ">
                            ...
                            <div class="card">
                                <div class="card-body border-bottom row">
                                    ...
                                    <div class="col-md-3" style="align-self: end;">
                                        <a href="{{route('demo_products.create')}}" class=" btn btn-primary btn-gradient round  ">Add Product</a>
                                    </div>
                                    ...
                                    <table class="datatables-ajax table table-responsive datatable_data_2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('demo_products.edit', ['demo_product' => $val->id]) }}?data={{ json_encode($get) }}" class="btn btn-info">
                                                        Edit
                                                    </a>
                                                    ...
                                                    <div class="modal fade modal-danger text-start" id="danger_ke{{ $val->id }}" tabindex="-1" aria-labelledby="myModalLabel120" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="{{route('demo_products.destroy',['demo_product' => $val->id]) }}" method="POST">
                                                                        @csrf
                                                                        @method('delete')
                                                                        <div class="modal-footer">
    ...
    <script>
        function ChangeSlabStatus (id){
            $.ajax({
                url: "{{ route('changes_demo_product_status') }}",
                type: 'POST',
                dataType: 'json',
                data: {
